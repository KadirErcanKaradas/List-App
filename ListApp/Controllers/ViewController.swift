...
//  ListApp
//
//  Created by Ercan Karadaş on 13.10.2022.
//
...
class ViewController: UIViewController{
    ...
    @IBAction func didRomeveBarButtonItemTapped(_ sender: UIBarButtonItem){
    ...
    func presentAddAlert(){
        presentAlert(title: "Yeni Eleman Ekle",
            ...
            if text != ""{
                ...
                self.prensentWarningAlert()
            }
            
        })
    }
    func prensentWarningAlert(){
        presentAlert(title: "Uyarı!",
